  ...
  projects: [
    {
      ...
      period: "2021 – 2022",
      description:
        "E-commerce prototype for mechanical keyboard products with cart and Stripe payment integration.",
    ...
    },
    {
      ...
      period: "2021",
      description:
        "CLI tool that scrambles private seed phrases for secure offline and online storage.",
      stack: "Python",
    },
  ],
};
...
function renderResume(target: HTMLElement, data: ResumeData) {
