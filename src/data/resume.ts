...
export const resume: ResumeData = {
  ...
  contact: [
    ...
    { label: "💼", value: "linkedin.com/in/thanhtinle", href: "https://www.linkedin.com/in/thanhtinle/" },
    { label: "💻", value: "github.com/tinlevn", href: "https://github.com/tinlevn" },
  ],
  summary:
  ...
  experience: [
    {
      ...
      bullets: [
        "Technologies: .NET 10, Angular 22, TypeScript, Azure, Kafka, Playwright, SQL Server, Kong.",
        "Lead end-to-end full-stack engineering across core financial platforms: Asset Transfer (major web app rewrite) and Corporate Actions, translating complex financial rules into resilient production systems.",
        "Own full architectural slices: Angular interfaces, .NET application handlers, domain models, database migrations, Kafka event workflows, and downstream transaction posting.",
        "Architect critical operational controls in Asset Transfer, including multi-step parcel lodgment, second-pair-of-eyes approvals, role-aware routing, and rejected-parcel recovery workflows.",
        "Implement complex Corporate Actions transaction mechanics, including redemption basis, allocation error propagation, takeover postings, and rollover relief.",
        "Drive quality and test automation across unit tests, API tests, and Playwright end-to-end suites; stabilize flaky pipelines, address Sonar/security concerns, and author Architecture Decision Records (ADRs).",
        "Maintain production health and infrastructure, handling managed identities, Kong gateway configurations, dependency vulnerability remediation, and automated health checks.",
      ],
    },
    {
